/**
 * Godot 3.x SDK Templates
 * Exports all template functions for Godot 3.x SDK generation
 */
...
/**
 * Register all Godot 3.x templates with the template engine
 */
export function registerGodot3Templates(engine: TemplateEngine): void {
  // Core templates
  engine.registerTemplate('godot3', 'plugin.cfg', pluginCfgTemplate);
  engine.registerTemplate('godot3', 'plugin.gd', pluginGdTemplate);
  engine.registerTemplate('godot3', 'ShardSDK.gd', shardSDKTemplate);

  // Recording templates
  engine.registerTemplate('godot3', 'recording/RecordingSDK.gd', recordingSDKTemplate);

  // Error tracking templates
  engine.registerTemplate('godot3', 'error_tracking/ErrorTrackingSDK.gd', errorTrackingSDKTemplate);

  // Multiplayer templates
  engine.registerTemplate('godot3', 'multiplayer/ShardMultiplayer.gd', shardMultiplayerTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardConnection.gd', shardConnectionTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardLobby.gd', shardLobbyTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardMatch.gd', shardMatchTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardInput.gd', shardInputTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardState.gd', shardStateTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardPrediction.gd', shardPredictionTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardProtocol.gd', shardProtocolTemplate);
  engine.registerTemplate('godot3', 'multiplayer/ShardEvents.gd', shardEventsTemplate);
}
